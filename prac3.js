...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': 'pr3_conds_low.csv', 'path': 'pr3_conds_low.csv'},
    ...
    {'name': 'pr3_conds_high.csv', 'path': 'pr3_conds_high.csv'},
    {'name': 'distr/nyusha.png', 'path': 'distr/nyusha.png'},
    {'name': 'distr/ezhik.png', 'path': 'distr/ezhik.png'},
    {'name': 'distr/barash.png', 'path': 'distr/barash.png'},
    {'name': 'distr/karych.png', 'path': 'distr/karych.png'},
  ...
  return async function () {
    ...
    fetch('https://pipe.jspsych.org/api/data', {
        ...
        headers: {
         ...
         body: JSON.stringify({
            experimentID: 'aKf4OqUvkE0B', // * UPDATE WITH YOUR DATAPIPE EXPERIMENT ID *
            filename: filename, 
            data: data,
         }),
